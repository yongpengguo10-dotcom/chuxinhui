...
import { ROLE_COLOR, STATUS_STYLES, effectiveStatus, isOverdue } from "../lib/taskUtils";
...
function Chip({ active, label, onClick, role, danger }: { active: boolean; label: string; onClick: () => void; role?: TaskRole; danger?: boolean }) {
  const c = role ? ROLE_COLOR[role] : danger ? { bg: "#FFE8E8", border: "#FFCCCC", text: "#CC3333" } : { bg: "#FFF9E6", border: "#F4C542", text: "#8A6500" };
  return (
    <button
      onClick={onClick}
