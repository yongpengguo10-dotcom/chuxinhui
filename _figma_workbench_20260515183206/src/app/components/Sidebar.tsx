...
import {
  LayoutDashboard, Briefcase, Megaphone, Sparkles, FolderClosed, Users, Image, Images,
...
const NAV_TREE: NavItem[] = [
  { key: "overview", label: "项目总览", icon: LayoutDashboard },
  {
    label: "项目总控", icon: Briefcase, children: [
      { key: "control.create", label: "创建项目", icon: Sparkles },
  ...
  { key: "recruitment", label: "招商中心", icon: Megaphone },
  {
    label: "市场中心", icon: Sparkles, children: [
      { key: "market.overview", label: "市场总览", icon: LayoutDashboard },
  ...
  },
  {
    label: "素材库", icon: FolderClosed, children: [
      { key: "library.people", label: "人物素材", icon: Users },
...
function findParentKey(active: NavKey): string | null {
...
export function Sidebar({ activeNav, onNavChange, isMobile = false, onCloseDrawer }: SidebarProps) {
  const [accountMenuOpen, setAccountMenuOpen] = useState(false);
  const initialExpanded = new Set<string>();
  const parent = findParentKey(activeNav);
